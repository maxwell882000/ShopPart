...
class CustomPlasticCardDynamic extends BaseLivewireDynamic
{
 ...
 public function sendSms(){return \App\Domain\User\Front\Admin\Functions\SendSmsLivewire::sendSms($this,...func_get_args());}
    ...
    {
        return 'livewire.admin.pages.custom-installment-show.custom-plastic-card-dynamic'; //4  --- path to blade
    }
    ...
    public function getEntity(){
        return 'App\Domain\Installment\CustomInstallment\Front\Dynamic\CustomPlasticCardDynamic'; //8  --- class name of entity
    }


    public function getServiceClass(): string
    {
        return  'App\Domain\Installment\CustomInstallment\Services\CustomPlasticCardInstalmentService'; //9
    }
}

...
namespace App\Http\Livewire\Admin\Pages\LentaCreate;  // 1  --- namespace

use App\Http\Livewire\Admin\Base\Abstracts\BaseLivewireNestedWithoutEntity;

//2 --- classname livewire
class ProductNested extends BaseLivewireNestedWithoutEntity
{
 ...
 public function activateChosen(){return $this->getEntity()::whereIn('id', $this->checkBox)
    ...
    {
        return 'livewire.admin.pages.lenta-create.product-nested'; //4  --- path to blade
    }
